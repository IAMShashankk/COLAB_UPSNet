...
def upsnet_test():
    ...
    results = []
    print('batch iteration end here.')
    ...
    print('all boxes lenght ->', len(all_boxes))
    ...
    pickle_out = open(os.path.join(final_output_path, 'results', 'results_list.pkl'),"wb")
