...
int deformable_im2col_cuda(
  ...
  float* data_im     = data_im_cuda.data_ptr<float>();
  float* data_offset = data_offset_cuda.data_ptr<float>();
  float* data_col    = data_col_cuda.data_ptr<float>();
...
int deformable_col2im_cuda(
  ...
  float* data_col    = data_col_cuda.data_ptr<float>();
  float* data_offset = data_offset_cuda.data_ptr<float>();
  float* grad_im     = grad_im_cuda.data_ptr<float>();
...
int deformable_col2im_coord_cuda(
  ...
  float* data_im     = data_im_cuda.data_ptr<float>();
  float* data_offset = data_offset_cuda.data_ptr<float>();
  float* grad_offset = grad_offset_cuda.data_ptr<float>();
